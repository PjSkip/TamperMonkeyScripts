...
(function () {
  ...
  var SCRIPT_VERSION = '2026.36.7.15';
  ...
  var RELEASE_NOTES =
    ...
    '• Quoted history and signatures are not walked, so Expand all does not freeze Gmail.';
  ...
  function processOneMessage(msg) {
    ...
    if (msg.querySelectorAll) {
      ...
      var snip = msg.querySelector('.iA.g6');
      if (snip && isShown(snip) && !isExpandedMsg(msg)) add(snip);
    }
    var i;
  ...
  var SKIP_WALK = /gmail_quote|gmail_extra|gmail_signature|gmail_signature_prefix|gmail_attr/;
